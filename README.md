...
This mirror of the SDK is currently set to support Skyrim Anniversary and Special Edition runtime: **1.6.1170.0 (0x01064920)** - SKSE64AE build: **0.2.2.6**, other versions will need to be manually configured.  
